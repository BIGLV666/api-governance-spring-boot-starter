package org.example.apigovernancespringbootstarter.async.aspect;
...
public final class AsyncActionAspect {
    ...
    @Around("@annotation(org.example.apigovernancespringbootstarter.async.annotation.AsyncAction)")
